...
describe('HealthConcern Management Component', () => {
  let comp: HealthConcernComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(HealthConcernComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.healthConcerns?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
