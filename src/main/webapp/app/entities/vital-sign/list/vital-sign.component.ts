...
export class VitalSignComponent implements OnInit {
  ...
  trackId(index: number, item: IVitalSign): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IVitalSign[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
